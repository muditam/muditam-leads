...
app.get('/api/orders', async (req, res) => {
  const shopifyAPIEndpoint = `https://${process.env.SHOPIFY_STORE_NAME}.myshopify.com/admin/api/2024-04/orders.json?status=any&created_at_min=2024-06-01T00:00:00Z&created_at_max=2024-08-31T23:59:59Z&limit=250`;
  try {
